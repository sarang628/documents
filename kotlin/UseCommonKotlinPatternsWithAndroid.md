...
## [널 가능성(Nullability) 와 초기화](https://developer.android.com/kotlin/common-patterns?_gl=1*1mfh22*_up*MQ..*_ga*MjA5MDI2ODYwNi4xNzY4NTQxNjEx*_ga_6HH9YJMN9M*czE3Njg1NDE2MTAkbzEkZzAkdDE3Njg1NDE2MTAkajYwJGwwJGgxMDQ0NDM4NjU3#fragment-nullability)
...
## [상호 운용성(Interoperability)](https://developer.android.com/kotlin/common-patterns?_gl=1*1mfh22*_up*MQ..*_ga*MjA5MDI2ODYwNi4xNzY4NTQxNjEx*_ga_6HH9YJMN9M*czE3Njg1NDE2MTAkbzEkZzAkdDE3Njg1NDE2MTAkajYwJGwwJGgxMDQ0NDM4NjU3&utm_source=android-studio-app&utm_medium=app#interop)
- 코틀린은 null safe를 처리할 수 있지만 Java는 그렇지 못함.
- 코틀린과 자바는 서로 호출 가능하기 떄문에 자바 호출 시 이 점 유의

## [플랫폼 타입(Platform types)](https://developer.android.com/kotlin/common-patterns?_gl=1*1mfh22*_up*MQ..*_ga*MjA5MDI2ODYwNi4xNzY4NTQxNjEx*_ga_6HH9YJMN9M*czE3Njg1NDE2MTAkbzEkZzAkdDE3Njg1NDE2MTAkajYwJGwwJGgxMDQ0NDM4NjU3&utm_source=android-studio-app&utm_medium=app#platform-types)
...
- !! 연산자 사용 (Not-null assertion operator). 타입을 non-null 타입이라 가정. NPE 발생할 수 있음
- ? 연산자 사용 (Safe call operator) . 안전하지만 null 반환 할 수 있음. Elvis ?: (Elvis operator) 를 사용해 null 값일 경우 default 설정 가능.
